  ...
  namespace TAG {
    class TagUInt16 : public TagParent {
      public:
        ...
        TagUInt16 (String _Name, String _Text, String _Comment, TagAccessType_T _Access, TagUsage_T _Usage, uint16_t *_Value, String _Unit, SetCallback _CB, TagTypes_T _Type = TypeUInt16);
        TagUInt16 (String _Name, String _Text, String _Comment, TagAccessType_T _Access, TagUsage_T _Usage, uint16_t *_Value, String _Unit, TagTypes_T _Type = TypeUInt16);
        ~TagUInt16 () { ; };
        String writeTag ();
