...
namespace JCA {
  namespace TAG {
     ...
     */
    TagFloat::TagFloat (String _Name, String _Text, String _Comment, TagAccessType_T _Access, TagUsage_T _Usage, float *_Value, String _Unit, SetCallback _CB, TagTypes_T _Type)
        : TagParent (_Name, _Text, _Comment, _Access, _Value, _Type, _Usage, _CB) {
      Unit = _Unit;
    }

    TagFloat::TagFloat (String _Name, String _Text, String _Comment, TagAccessType_T _Access, TagUsage_T _Usage, float *_Value, String _Unit, TagTypes_T _Type)
    ...
    bool TagFloat::writeTag (JsonObject &_Tag) {
     ...
     */
    bool TagFloat::getValue (JsonVariant _Value, TagAccessType_T _Access) {
     ...
     * @return false something failed
     */
    bool TagFloat::setValue (JsonVariant _Value, TagAccessType_T _Access) {
     ...
     */
    void TagFloat::addValue (JsonObject &_Values, TagAccessType_T _Access) {
      if ((Access & ~TagAccessType_T::Write & _Access) == 0) {
        // Access-Type is not allowed
        if (Debug.print (FLAG_DATA, true, Name, __func__, "Access-Type not allowed: Access=")) {
          Debug.println (FLAG_DATA, true, Name, __func__, Access);
