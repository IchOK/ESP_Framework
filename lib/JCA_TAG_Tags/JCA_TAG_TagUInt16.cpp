...
namespace JCA {
  namespace TAG {
    /**
     * @brief Construct a new TagUInt16::TagUInt16 object
     *
     ...
     */
    TagUInt16::TagUInt16 (String _Name, String _Text, String _Comment, TagAccessType_T _Access, TagUsage_T _Usage, uint16_t *_Value, String _Unit, SetCallback _CB, TagTypes_T _Type)
        : TagParent (_Name, _Text, _Comment, _Access, _Value, _Type, _Usage, _CB) {
      Unit = _Unit;
    }

    TagUInt16::TagUInt16 (String _Name, String _Text, String _Comment, TagAccessType_T _Access, TagUsage_T _Usage, uint16_t *_Value, String _Unit, TagTypes_T _Type)
     ...
     */
    bool TagUInt16::getValue (JsonVariant _Value, TagAccessType_T _Access) {
     ...
     * @return false something failed
     */
    bool TagUInt16::setValue (JsonVariant _Value, TagAccessType_T _Access) {
     ...
     */
    void TagUInt16::addValue (JsonObject &_Values, TagAccessType_T _Access) {
      if ((Access & ~TagAccessType_T::Write & _Access) == 0) {
        // Access-Type is not allowed
        if (Debug.print (FLAG_DATA, true, Name, __func__, "Access-Type not allowed: Access=")) {
          Debug.println (FLAG_DATA, true, Name, __func__, Access);
