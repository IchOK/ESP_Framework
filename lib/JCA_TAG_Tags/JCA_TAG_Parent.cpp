...
namespace JCA {
  namespace TAG {
    TagParent::TagParent (String _Name, String _Text, String _Comment, TagAccessType_T _Access, void *_Value, TagTypes_T _Type, TagUsage_T _Usage, SetCallback _CB) {
      Type = _Type;
      Usage = _Usage;
      Name = _Name;
      Text = _Text;
    ...
    TagParent::TagParent (String _Name, String _Text, String _Comment, TagAccessType_T _Access, void *_Value, TagTypes_T _Type, TagUsage_T _Usage) {
      Type = _Type;
      Usage = _Usage;
      Name = _Name;
      Text = _Text;
    ...
    String TagParent::writeTagBase () {
      ...
      SetupTag += ",\"" + String (JCA_TAG_TAGS_JsonReadOnly) + "\":" + ((Access & TagAccessType_T::Write) ? "0" : "1");
      if (Comment.length() > 0) {
