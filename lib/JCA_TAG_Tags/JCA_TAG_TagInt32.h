  ...
  namespace TAG {
    class TagInt32 : public TagParent {
      public:
        ...
        TagInt32 (String _Name, String _Text, String _Comment, TagAccessType_T _Access, TagUsage_T _Usage, int32_t *_Value, String _Unit, SetCallback _CB, TagTypes_T _Type = TypeInt32);
        TagInt32 (String _Name, String _Text, String _Comment, TagAccessType_T _Access, TagUsage_T _Usage, int32_t *_Value, String _Unit, TagTypes_T _Type = TypeInt32);
        ~TagInt32 () { ; };
        String writeTag ();
