...
namespace JCA {
  namespace FNC {
    ...
    ValueAnalog::ValueAnalog (String _Name, String _Unit)
      ...
      // Create Tag-List
      Tags.push_back (new TagFloat ("Value", "Wert", "", static_cast<TagAccessType_T>(TagAccessType_T::ReadWrite | TagAccessType_T::Save), TagUsage_T::UseData, &Value, _Unit));
      // Init Data
      Value = false;
    }
    ...
    void ValueAnalog::GetSetupSchema(JsonObject &_Schema) {
      ...
      UnitParam["comment"] = "Einheit des Werts";
    }
  }
}
