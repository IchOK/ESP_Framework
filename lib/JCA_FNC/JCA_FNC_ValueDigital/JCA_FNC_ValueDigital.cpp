...
namespace JCA {
  namespace FNC {
    const char *ValueDigital::ClassName = "ValueDigital";
    const char *ValueDigital::SetupTagType = "valueDigital";
    /**
     * @brief Construct a new ValueDigital::ValueDigital object
     *
     * @param _Name Element Name inside the Communication
     */
    ValueDigital::ValueDigital (String _Name)
        : FuncParent (_Name) {
     ...
     */
    void ValueDigital::AddToHandler (JCA::IOT::FuncHandler &_Handler) {
     ...
     * @return false 
     */
    bool ValueDigital::Create (JsonObject _Setup, JsonObject _Log, std::vector<FuncParent *> &_Functions, std::map<String, void *> _Hardware) {
      ...
      if (Done) {
        _Functions.push_back (new ValueDigital(Name));
        Log["done"] = Name;
    ...
    void ValueDigital::GetSetupSchema(JsonObject &_Schema) {
